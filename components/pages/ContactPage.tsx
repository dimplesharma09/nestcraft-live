      ...
      <div className="pb-20 bg-background">
              ...
              <div className="bg-surface border border-border p-10 lg:p-16 rounded-[48px] shadow-2xl relative z-10">
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                      <div className="space-y-3">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent border-b-2 border-border py-4 outline-none focus:border-secondary transition-all font-bold text-xl placeholder:text-muted"
                        />
                      </div>
                      <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-[3px] text-muted ml-1">Store Information</label>
                      <select
                        name="store"
                        className="w-full bg-transparent border-b-2 border-border py-4 outline-none focus:border-secondary transition-all font-bold text-xl appearance-none cursor-pointer"
                        onChange={(e) => {
                          if (e.target.value === "/stores") {
                            window.location.href = e.target.value;
                          }
                        }}
                      >
                        <option value="" className="bg-surface">Select Store Reference</option>
                        <option value="/stores" className="bg-surface">Store Page</option>
                      </select>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full bg-transparent border-b-2 border-border py-4 outline-none focus:border-secondary transition-all font-bold text-xl resize-none placeholder:text-muted"
                      />
                    </div>
        ...
        <section className="px-[5%] max-w-7xl mx-auto pb-32">
          <div className="relative h-[600px] rounded-[60px] overflow-hidden border border-border shadow-2xl group">
            <img
              src="https://cdn.dnaindia.com/sites/default/files/styles/full/public/2019/07/07/845521-jaipur-1.jpg"
              alt="Map"
            ...
            <div className="absolute bottom-12 left-12 right-12 flex flex-col md:flex-row justify-between items-end gap-8">
              <div className="bg-surface/80 backdrop-blur-xl p-10 rounded-[40px] border border-border max-w-md shadow-2xl">
                <h4 className="text-2xl font-black mb-4 tracking-tight">Visit the Store</h4>
